...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Connect — বাংলা সংবাদ ও মতামত" },
      { name: "description", content: "The Connect — বাংলা ভাষায় খবর, বিশ্লেষণ ও মতামতের নির্ভরযোগ্য পোর্টাল।" },
      { property: "og:site_name", content: "The Connect" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Hind+Siliguri:wght@400;500;600;700&family=Tiro+Bangla:ital@0;1&display=swap" },
